const paymentSuccessEmailTemplate = (name, amount, orderId, paymentId) => {
  ...
  <body>
    <div class="container">
      ...
      <!-- Footer -->
      <div class="support">
        <p>If you have any questions or need assistance, please feel free to reach out to us at <a href="mailto:nishantmanocha05@gmail.com">nishantmanocha05@gmail.com</a>. We are here to help!</p>
      </div>
    </div>
	</body>
	</html>
